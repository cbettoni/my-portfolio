...
const Button: React.FC<ButtonProps> = ({ variant = "btn_primary", className, ...props }) => {
    const baseClasses =
        "inline-flex items-center justify-center gap-2 rounded-md text-sm font-medium transition-colors focus:outline-none focus:ring-1 focus:ring-ring disabled:opacity-50";
    const variantClasses = {
        btn_primary:
            "p-4 bg-green-cb text-dark-grey-cb border-2 border-transparent hover:bg-dark-grey-cb focus:border-dark-grey-cb focus:ring-4 focus:ring-dark-grey-cb",
        btn_secondary:
